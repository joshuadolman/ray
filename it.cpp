...
Main(HINSTANCE Instance)
{
    ...
    {
        Materials[0].Color = V3(0.3f, 0.4f, 1.0f);

        Materials[1].Color = V3(0.9f, 0.4f, 0.2f);
        Materials[2].Color = V3(0.7f, 1.0f, 0.6f);
    }
    World.MaterialCount = ArrayCount(Materials);
    World.Materials     = Materials;

    World.Ground.Normal   = V3(0.0f, 0.0f, 1.0f);
    World.Ground.Distance = 0.0f;
    World.Ground.MatIndex = 2;

    sphere Spheres[1] = {0};
    {
        Spheres[0].Position = V3(0.0f, 0.0f, 0.0f);
